...
- Объявление переменных
  ...
  - тип переманных-коллекций нужно объявлять интерфейсом: не HashMap, а Map
  - имена переменных должны быть информативные, служат заменой комментариям 

- Оформление
  - представьте, что это ваше тестовое задание на работу. Не должно быть лишних комментариев, TODO, ..
  - комментариев должен быть минимум (самодокументируемый код). Если таки есть- лучше на english.
